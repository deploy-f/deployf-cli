...
// WithAppID adds the appID to the get params
func (o *GetParams) WithAppID(appID int32) *GetParams {
	o.SetAppID(appID)
	return o
}

// SetAppID adds the appId to the get params
func (o *GetParams) SetAppID(appID int32) {
	o.AppID = appID
}
