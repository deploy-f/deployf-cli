...
// WithData adds the data to the update params
func (o *UpdateParams) WithData(data *models.CustomDomainDto) *UpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the update params
func (o *UpdateParams) SetData(data *models.CustomDomainDto) {
	o.Data = data
}
