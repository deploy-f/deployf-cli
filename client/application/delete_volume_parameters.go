...
func (o *DeleteVolumeParams) WithID(id int32) *DeleteVolumeParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete volume params
func (o *DeleteVolumeParams) SetID(id int32) {
	o.ID = id
}

// WithVolumeID adds the volumeID to the delete volume params
func (o *DeleteVolumeParams) WithVolumeID(volumeID int32) *DeleteVolumeParams {
	o.SetVolumeID(volumeID)
	return o
}

// SetVolumeID adds the volumeId to the delete volume params
func (o *DeleteVolumeParams) SetVolumeID(volumeID int32) {
	o.VolumeID = volumeID
}
...
func (o *DeleteVolumeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param volumeId
	if err := r.SetPathParam("volumeId", swag.FormatInt32(o.VolumeID)); err != nil {
		return err
	}
