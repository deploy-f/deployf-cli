...
type CreateParams struct {
	...
	/*Data*/
	Data *models.ReadyApplicationDetailsDto
...
// WithData adds the data to the create params
func (o *CreateParams) WithData(data *models.ReadyApplicationDetailsDto) *CreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the create params
func (o *CreateParams) SetData(data *models.ReadyApplicationDetailsDto) {
	o.Data = data
}
